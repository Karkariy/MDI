...
public class ChessboardCustomStrategy extends Strategy {

	private int chessboardH;
	private int chessboardW;

	public ChessboardCustomStrategy(int height, int width) {
		super();
	...
	public void cheessboardExecutor(Chessboard chessboard,Player plWhite, Player plBlack) {
		...
		chessboard.setChessBordSizeH(chessboardH);
		chessboard.setChessBordSizeW(chessboardW);
