...
public class JChessApp extends SingleFrameApplication {
    ...
    protected void startup() 
    {
        ...
        String j1 = "J"+ random.nextInt() +"White";
        String j2 = "J"+ random.nextInt() + "Black";
        Game newGUI = javaChessView.addNewTab(j1 + " vs " + j2);
        ...
        pl1.setName(j1);//set name of player
        pl2.setName(j2);//set name of player
