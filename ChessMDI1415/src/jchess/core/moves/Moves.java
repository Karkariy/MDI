...
public class Moves extends AbstractTableModel
{
    ...
    {
        Settings.lang("white"), Settings.lang("black"), //Settings.lang("Comments")
    };
    ...
    { 
        ...
        this.table.setMinimumSize(new Dimension(10, 100));
        this.game = game;
    ...
    {
        return "Moves/getValueAt"; //this.move.get((y * 2) - 1 + (x - 1));
    }
    ...
    public String getMove(Square begin, Square end, boolean registerInHistory, Castling castlingMove, boolean wasEnPassant, Piece promotedPiece, String comment, float temps)
    {
    ...
    public void addMove(Square begin, Square end, boolean registerInHistory, Castling castlingMove, boolean wasEnPassant, Piece promotedPiece, String comment, float t)
    {
        boolean wasCastling = castlingMove != Castling.NONE;
        String test = getMove(begin, end, registerInHistory, castlingMove, wasEnPassant, promotedPiece, comment, t);
        ...
        {
            this.move.add(test);
            this.addMove2Table(test);
        }
        this.scrollPane.scrollRectToVisible(new Rectangle(0, this.scrollPane.getHeight() - 2, 1, 1));

        if (registerInHistory)
        {
            Move moveToAdd = new Question6(new Square(begin), new Square(end), begin.piece, end.piece, castlingMove, wasEnPassant, promotedPiece, comment, t );
