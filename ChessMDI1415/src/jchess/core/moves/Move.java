...
public class Move
{
    ...
    protected float time = (float) 0.0;

    Move(Square from, Square to, Piece movedPiece, Piece takenPiece, Castling castlingMove, boolean wasEnPassant, Piece promotedPiece, String Commentaire, float temps)
    {
        ...
        if(movedPiece.getName().equals("Tourette")){
        	JOptionPane.showMessageDialog(null, Tourette.getInsulte(), "InfoBox: Tourette message", JOptionPane.INFORMATION_MESSAGE);
        }
    }
