...
public class Game extends JPanel implements ComponentListener, MouseListener
{
    ...
    protected Survivants survi;
    protected Score points;
    protected Exo5 exercice5;
    
    protected JTabbedPane tabPane;
   
    public LocalSettingsView localSettingsView;
    ...
    public Game()
    {
        ...
        chessboard = new Chessboard(this.getSettings(), this.moves, this.hauteur, this. largeur, this.localSettingsView.CommentZone);        
        ...
        Moves.setSize(new Dimension(180, 50)); //180 350
        Moves.setMaximumSize(new Dimension (180, 150));
        Moves.setLocation(new Point(100, 50)); // 500 121
        this.add(Moves);
        ...
        this.tabPane.setSize(new Dimension(50, 50)); //380 100
        this.tabPane.setLocation(new Point(chessboardWidth, chessboardWidth/3));
        this.tabPane.setMinimumSize(new Dimension(50, 50));  //400 100      
        this.add(tabPane);
        ...
        this.survi = new Survivants(this);
        this.points = new Score(this);
        
    }
    
    public String getComment()
    {
    	System.out.println(this.localSettingsView.CommentZone.getText());
    	return this.localSettingsView.CommentZone.getText();
    }
    ...
    public void nextMove()
    {
        ...
        boolean time = false;
        // affichage dans la console des pieces restante sur le plateau et du score de chaque couleur
        this.survi.countPieces(this.getChessboard().getSquares());
        System.out.println("Noir : " + this.points.getScoreNoir() + "\t Blanc : " + this.points.getScoreBlanc() );
 
        
        if (this.moves.move.size()<=1) {time = this.getLocalSettingsView().initTimeControl();}
        System.out.println(time);
     	if (time == true) {this.getGameClock().start();} // ya un truc a faire ici // le truc est fait
