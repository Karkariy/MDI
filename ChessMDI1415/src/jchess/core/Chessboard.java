...
import jchess.core.pieces.implementation.Tourette;
...
public class Chessboard 
{
     ...
     */
    public Chessboard(Settings settings, Moves Moves, int n, int m, JTextArea t)
    {
        ...
        this.squares = new Square[n][m];//initalization of nxm chessboard
    ...
    private void setFigures4NewGame(int i, Player player)
    {
        ...
        this.getSquare(7, i).setPiece(new Tourette(this, player));
    ...
    public void move(Square begin, Square end, boolean refresh, boolean clearForwardHistory)
    {
        ...
        if (clearForwardHistory)
        {
            ...
            this.Moves.addMove(tempBegin, tempEnd, true, wasCastling, wasEnPassant, promotedPiece, text.getText(),(float) LocalDateTime.now().getSecond() - temps );
            System.out.println((float) System.currentTimeMillis() - temps);
        }
        else
        {
            this.Moves.addMove(tempBegin, tempEnd, false, wasCastling, wasEnPassant, promotedPiece, text.getText(),(float) LocalDateTime.now().getSecond() - temps );
        }
        temps = LocalDateTime.now().getSecond();
    }/*endOf-move()-*/
